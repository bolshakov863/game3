...
def menu_enter(canvas, player_size, player1, player2, set_status, y1, y2):
    if menu_current_index == 0:
        ...
        game_new(canvas, player_size, player1, player2)
    elif menu_current_index == 2:
        game_save(canvas, player1, player2, set_status)
    elif menu_current_index == 3:
        game_load(canvas, player1, player2, y1, y2, player_size, set_status)
...
def game_new(canvas, player_size, player1, player2):
    # menu_toggle()
    x1, y1 = 50, 50
...
def game_load(canvas, player1, player2, y1, y2, player_size, set_status):
